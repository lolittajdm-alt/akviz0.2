...
const goalsList = ["Вибух", "Постріли(ЗУ,кулемет)"];
// Список названий
...
export default function Home() {
  ...
  const selectSide = (s) =>
    setForm((f) => ({ ...f, side: f.side === s ? null : s }));
  ...
  const onAzimuthChange = (e) => {
    ...
    setErrors((err) => ({ ...err, azimuth: !validate(v, 3) }));
  };
  const onCourseChange = (e) => {
    const v = e.target.value.replace(/\D/g, "").slice(0, 3);
    setForm((f) => ({ ...f, course: v }));
    setErrors((err) => ({ ...err, course: !validate(v, 3) }));
  };
  const onDistanceChange = (e) => {
    const v = e.target.value.replace(/\D/g, "").slice(0, 5);
    setForm((f) => ({ ...f, distance: v }));
    setErrors((err) => ({ ...err, distance: !validate(v, 5) }));
  };
  const onHeightChange = (e) => {
    const v = e.target.value.replace(/\D/g, "").slice(0, 5);
    setForm((f) => ({ ...f, height: v }));
    setErrors((err) => ({ ...err, height: !validate(v, 5) }));
  };
  ...
  const openWhatsApp = () =>
    window.open(
      `whatsapp://send?text=${encodeURIComponent(generateReportText())}`
    );
  ...
  const iosInput = {
    ...
    borderRadius: "12px",
    border: "none",
    backgroundColor: isDarkMode ? "#3C3C3E" : "#ECECEC",
    fontSize: "1rem",
    marginBottom: "0.6rem",
    ...
    <div style={iosContainer}>
          ...
          {goalsList.map((g) => (
            <button
              ...
              style={{
                ...
                background: form.selectedGoals.includes(g)
                  ? "#32D74B"
                  : iosButton.background,
                color: form.selectedGoals.includes(g)
                  ? "#fff"
                  : iosButton.color,
                borderRadius: "8px",
              }}
        ...
        <div style={{ display: "flex", gap: "0.5rem" }}>
          {["Ворожий", "Свій", "Нейтральний"].map((s) => (
            <button
              ...
              style={{
                ...iosButton,
                background: form.side === s ? "#32D74B" : iosButton.background,
                color: form.side === s ? "#fff" : iosButton.color,
              }}
            >
              {s}
            </button>
      ...
      {!form.noIssue && (
        <div style={iosCard}>
          ...
          {!form.targetNumber && (
            <div style={{ color: "#FF3B30" }}>Вкажіть номер</div>
          )}
        </div>
      )}
      <div style={iosCard}>
        ...
        <div style={{ display: "flex", gap: "0.5rem" }}>
          {namesList.map((n) => (
            <button
              ...
              style={{
                ...iosButton,
                background: form.name === n ? "#32D74B" : iosButton.background,
                color: form.name === n ? "#fff" : iosButton.color,
              }}
            >
              {n}
            </button>
      ...
      <div style={iosCard}>
        ...
        >
          <button
            ...
            style={{ ...iosButton, background: "#FF375F" }}
          ...
          <button
            onClick={() => changeQuantity(1)}
            style={{ ...iosButton, background: "#32D74B" }}
          >
            +
          </button>
        </div>
      ...
      <div style={iosCard}>
        ...
        <input
          ...
          style={{
            ...iosInput,
            border: errors.azimuth ? "1px solid #FF3B30" : "none",
          }}
        />
      </div>
      <div style={iosCard}>
        ...
        <input
          ...
          style={{
            ...iosInput,
            border: errors.course ? "1px solid #FF3B30" : "none",
          }}
        />
      </div>
      <div style={iosCard}>
        ...
        <input
          ...
          style={{
            ...iosInput,
            border: errors.distance ? "1px solid #FF3B30" : "none",
          }}
        />
      </div>
      <div style={iosCard}>
        ...
        <input
          ...
          style={{
            ...iosInput,
            border: errors.height ? "1px solid #FF3B30" : "none",
          }}
        />
      </div>
      <div style={iosCard}>
        ...
        <button
          onClick={() =>
            toggleDetection("Із застосуванням приладів спостереження")
          }
          style={iosButton}
        >
          ...
          {[
            ...
            <button
              ...
              style={{
                ...iosButton,
                background:
                  form.result === r ? "#32D74B" : iosButton.background,
              }}
            >
              {r}
            </button>
      ...
      <div style={iosCard}>
        <label style={iosLabel}>Інфо</label>
        <textarea
          name="additionalInfo"
      ...
      <div style={{ display: "flex", gap: "0.5rem", marginBottom: "1rem" }}>
        ...
        <button style={{ ...iosButton, background: "#34C759", color: "#FFF" }} onClick={openWhatsApp}>
          WhatsApp
        </button>
      </div>
      <div style={iosCard}>
